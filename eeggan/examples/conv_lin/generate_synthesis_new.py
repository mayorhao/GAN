...
gen_model_path='./models/edf-5_fold/k_fold_{}/{}/Progressive0.gen'.format(fold_idx,N_STAGE)
disc_model_path='./models/edf-5_fold/k_fold_{}/{}/Progressive0.disc'.format(fold_idx,N_STAGE)
...
def main():
    ...
    #store
    fig_path=os.path.join('./analysis/pick-data-edf/fold-{}'.format(fold_idx),N_STAGE)
